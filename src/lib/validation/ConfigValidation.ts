...
export const ConfigSchema = z.object({
  ...
  website: z.string().url({message: "url tidak valid"}).optional(),
  emaiOrganisasi: z
  ...
  urlinstagram : z.string().url({message : "url tidak valid"}).optional(),
  urlfacebook : z.string().url({message : "url tidak valid"}).optional(),
  urllinkedIn : z.string().url({message : "url tidak valid"}).optional()
});
